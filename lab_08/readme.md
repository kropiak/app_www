...
> **Zasoby**:
> 1. Oficjalna strona Django: https://docs.djangoproject.com/en/4.2/topics/testing/
...
W zależności od projektu można przyjąć inną strukturę, ale należy pamiętać o odpowniednich ścieżkach importu modułów Django. Przykład innej organizacji imkonfiguracji można znaleźć np. tutaj: https://docs.djangoproject.com/en/4.2/topics/testing/advanced/#testing-reusable-applications
...
**Zadanie 3**  
Posiłkując się dokumentacją oraz przykładami z załączonych poradników, napisz test dla jednego widoku. Sprawdź poprawność statusu protokołu HTTP dla żądania tego widoku.
...
\* nie jest obowiązkowe, ale warto bibliotekę Selenium znać